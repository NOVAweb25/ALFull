      ...
      <div className="relative w-full md:w-1/2 flex flex-col justify-center items-center md:items-start px-6 md:px-20 py-12 md:py-16">
        ...
        >
          <p className="text-base md:text-lg leading-relaxed text-white/90 mb-4">
            أن نصبح من بين الشركات الرائدة في مجال التطوير العقاري والبنية التحتية في المملكة العربية السعودية، من خلال تنفيذ مشاريع عالية القيمة تجمع بين الابتكار والاستدامة، وتواكب تطلعات رؤية 2030 نحو مستقبل أكثر إشراقاً وازدهاراً.
          </p>
