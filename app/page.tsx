...
export default function SplashPage() {
  ...
  const logoVariants = {
    ...
    visible: { opacity: 1, scale: 1, transition: { type: "spring", stiffness: 70, damping: 12 } },
  };
...
`}</style>
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              transition={{ staggerChildren: 0.25, delayChildren: 0.8 }} // تأخير بعد ظهور الخط
            >
              <motion.p variants={textVariants} className="text-[#FFD166] text-xl md:text-2xl font-medium tracking-wide text-right">
                الفل للمقاولات و التطوير العقاري
              </motion.p>
              <motion.p variants={textVariants} className="text-[#FFD166] text-lg md:text-xl font-medium tracking-wide text-left">
